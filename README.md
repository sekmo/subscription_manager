...
```sh
git clone https://github.com/nickjj/docker-rails-example subomatic
cd subomatic
...
The app is named `subomatic` right now but chances are your app will be a different
name. Since the app is already created we'll need to do a find / replace on a
few variants of the string "subomatic" and update a few Docker related resources.
